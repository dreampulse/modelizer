...
var Model = function(modelName, schema) {
  ...
  this.create = function(initValues) {
  ...
  this._initObject = function() {
    ...
    //  obj[i] = function() {
    //    return self.callMethod(i, arguments);
    //  }
...
//    }
    ...
    for (var i in self.attrArrays) {
      ...
      var arrayName = i;
      arrayName = arrayName[0].toUpperCase() + arrayName.substr(1);
      obj["create" + arrayName] = this.createArrayElement(self.attrArrays[i], obj, i);
    }
...
//      }
    ...
    callOp : function(operationName, params, HTMLrequest) {
      ...
      return self.callOp(operationName, params, HTMLrequest);
    }
  ...
  this.callOp = function(operationName, params, HTMLrequest) {
    return self.collection.callOperation(operationName, params, HTMLrequest);
  };

  // serialize doc
  this._transform = function(model, doc, method) {
