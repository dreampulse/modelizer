...
var Model = (function () {
    function Model(modelName, collection) {
        this.type = modelName;
        this.id = ObjectId();
    ...
    Model.prototype.bind = function (to) {
        this._binding = to;
    };

    Model.prototype.change = function (obj) {
        if (this._binding) {
            this._binding(obj);
        }
    };
...
var User = (function (_super) {
    ...
    function User() {
        _super.call(this, "users", appCollection);
    }
    return User;
})(Model);
...
//    }
//});
var localView = new View("theView", function (obj, emit, getObj) {
    if (obj.type === "users") {
        var user = obj;
        if (user.id === 'id:user2')
            getObj("id:user1");
...
var remoteView = new View("theView", function (obj, emit, getObj) {
    if (obj.type === "users") {
        var user = obj;
        if (user.id === 'id:user2')
            getObj("id:user1");
